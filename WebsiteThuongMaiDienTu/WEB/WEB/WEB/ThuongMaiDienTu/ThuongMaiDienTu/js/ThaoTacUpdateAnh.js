...
function showFile(file) {
    ...
    if (validExtensions.includes(fileType)) {
        ...
        fileReader.onload = function () {
            ...
            //const imgTag = '<img  class="w-100 h-100" src="' + fileUrl + '">';
            ...
            /*huyluu.innerHTML = '<button type="button" class="btn btn-outline-danger" onclick="resett()" data-bs-dismiss="modal">Hủy Lưu</button>';*/
        }
